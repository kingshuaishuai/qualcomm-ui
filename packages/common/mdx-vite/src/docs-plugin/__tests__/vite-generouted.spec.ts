...
const filePaths = {
  navItems: resolve(
    __dirname,
    "./fixtures/vite-generouted/mock-data/nav-items.json",
  ),
  pageMap: resolve(
    __dirname,
    "./fixtures/vite-generouted/mock-data/page-map.json",
  ),
  routesDir: resolve(__dirname, "./fixtures/vite-generouted/pages"),
  searchIndex: resolve(
    __dirname,
    "./fixtures/vite-generouted/mock-data/search-index.json",
  ),
}
...
describe("MDX Docs Plugin", () => {
  test("Vite Search Indexer", () => {
    ...
    const indexer = new SearchIndexer({
      ...
      pageDirectory: "pages",
      routingStrategy: "vite-generouted",
      srcDir: resolve(__dirname, "./fixtures/vite-generouted"),
    })
